...
<section class="banner_section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12">
                <img src="<?php echo base_url('assets/images/Shopping-Download-PNG-removebg-preview.png') ?>" class="banner_img" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($proDetailsFetch as $key => $value) { ?>
                <div class="col-md-3 proAllList">
                    <img src="<?php echo base_url('admin/images/' . $value['image1']) ?> " class="sliderImageIndex">
                    <h3> <?= substr($value['product_name'], 0, 25) . "....."  ?>
                    </h3>
                    <h4>&#8377 <?= $value['selling_price'] ?> <del>&#8377 <?= $value['selling_price'] ?></del></h4>
                    <h4><?= $value['Color'] ?></h4>
                    ...
                    <div class="products_textbox">
                        <div class="products_ulbox">
                            <ul>
                                <li>
                                    <a href="<?= base_url('proDetails/' . $value['id']) ?>"><button><svg xmlns="http://www.w3.org/2000/svg" class="products_ulboxicon" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
